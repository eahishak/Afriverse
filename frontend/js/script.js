document.addEventListener("DOMContentLoaded", function () {
    ...
    async function getResponse(message) {
        const responses = {
            ...
            'about emmanuel ahishakiye': 'Emmanuel Ahishakiye is the Founder, Spokesperson & CTO of Jackal Tech. He is a skilled software engineer with a passion for technology and innovation.',
            ...
            'founders': 'The founders of Jackal Tech are Ignace Kwizera, Emmanuel Ahishakiye, and Placide Shema.',
            ...
            'our linkedin': 'Follow us on LinkedIn at [Jackal Tech Ltd](https://www.linkedin.com/company/100128722/admin/feed/posts/).',
            'our services': 'We offer healthcare, education, finance, manufacturing, agriculture, retail, transportation, and energy services.',
            'our instagram': 'Follow us on Instagram at [@jackal_tech](https://www.instagram.com/jackal_tech/).',
            'our x': 'Follow us on X (formerly Twitter) at [@jackaltechltd](https://twitter.com/jackaltechltd).',
            'our youtube': 'Subscribe to our YouTube channel at [Jackal Tech](https://www.youtube.com/channel/UC123456789).',
            'email for branding': 'For branding inquiries, please email us at branding@jackaltechltd.com.',
            'follows us': 'You can follow us on LinkedIn, Instagram, X (formerly Twitter), and YouTube for the latest updates.',
